...
FILES = main.c window.c manage_struct.c prog.c what_user_do.c check_wall.c utils.c event.c

FILESPARS = ${pars}parsing.c ${pars}for_parsing_map.c ${pars}for_parsing_text.c
