...
FILES = main.c window.c manage_struct.c minimap.c what_user_do.c check_wall.c utils.c event.c print_view.c check_horiz_inter.c check_vert_inter.c print3d.c texture.c raycasting.c chain_list.c sprite.c free_struc.c
